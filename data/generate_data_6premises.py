...
def generate_syllogisms_problem(category):
    ...
    pseudoword3 = generate_pseudoword()
    ...
    premise2 = f"All {pseudoword2}s are {pseudoword3}s."
    premise3 = f"All {pseudoword3}s are {adj1}."
    premise4 = f"All {adj1} things are {adj2}."
    premise5 = f"All {adj2} things are {adj3}."

    # true affirm
    if category == '6_true_affirm':
        premise6 = f"{character} is a {pseudoword1}."
        conclusion = f"{character} is {adj3}."
    # false affirm
    elif category == '6_false_affirm':
        premise6 = f"{character} is not {adj3}."
        conclusion = f"{character} is a {pseudoword1}."
    # true negate
    elif category == '6_true_negate':
        premise6 = f"{character} is not {adj3}."
        conclusion = f"{character} is not a {pseudoword1}."
    # false negate
    elif category == '6_false_negate':
        conclusion = f"{character} is not {adj3}."
        if random.random() < 0.5:
            premise6 = f"{character} is a {pseudoword1}."
        else:
            premise6 = f"{character} is not a {pseudoword1}."
...
def generate_transitive_problem(category):
    ...
    c1, c2, c3, c4, c5, c6, c7 = random.sample(characters, 7)
    ...
    premise6 = f"{c6} is {adj} than {c7}."

    # true affirm
    if category == '6_true_affirm':
        conclusion = f"{c1} is {adj} than {c7}."
    # false affirm
    elif category == '6_false_affirm':
        conclusion = f"{c7} is {adj} than {c1}."
    # true negate
    elif category == '6_true_negate':
        conclusion = f"{c7} is not {adj} than {c1}."
    # false negate
    elif category == '6_false_negate':
        conclusion = f"{c1} is not {adj} than {c7}."
...
save_to_json(data, "deductive_reasoning_data_test_6premises.json")
