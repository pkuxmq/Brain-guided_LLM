...
adjectives = [
    "ancient", "modern", "fierce", "gentle", "elegant",
    "clumsy", "swift", "lazy", "curious", "mysterious",
    "fragile", "sturdy", "noisy", "silent", "graceful",
    "awkward", "clever", "foolish", "generous", "selfish"
]
...
characters = [
    ...
    # 4-letter names
    "Arix", "Belo", "Cavo", "Dren", "Eron",
    "Fira", "Glim", "Haro", "Iven", "Kora"
]
...
comparative_adjectives = [
    "easier", "busier", "noisier", "safer", "riskier",
    "wiser", "cleverer", "luckier", "healthier", "cheaper",
    "costlier", "earlier", "later", "rarer", "simpler",
    "stricter", "looser", "fairer", "nearer", "further"
]
...
syllogisms_data = generate_syllogisms_dataset(2)
transitive_data = generate_transitive_dataset(2)
data = {'syllogisms': syllogisms_data, 'transitive': transitive_data}
save_to_json(data, "deductive_reasoning_data_train_32.json")

syllogisms_data += generate_syllogisms_dataset(2)
transitive_data += generate_transitive_dataset(2)
data = {'syllogisms': syllogisms_data, 'transitive': transitive_data}
save_to_json(data, "deductive_reasoning_data_train_64.json")

syllogisms_data += generate_syllogisms_dataset(2)
transitive_data += generate_transitive_dataset(2)
data = {'syllogisms': syllogisms_data, 'transitive': transitive_data}
save_to_json(data, "deductive_reasoning_data_train_96.json")

syllogisms_data += generate_syllogisms_dataset(2)
transitive_data += generate_transitive_dataset(2)
data = {'syllogisms': syllogisms_data, 'transitive': transitive_data}
save_to_json(data, "deductive_reasoning_data_train_128.json")

syllogisms_data += generate_syllogisms_dataset(2)
transitive_data += generate_transitive_dataset(2)
data = {'syllogisms': syllogisms_data, 'transitive': transitive_data}
save_to_json(data, "deductive_reasoning_data_train_160.json")

syllogisms_data += generate_syllogisms_dataset(2)
transitive_data += generate_transitive_dataset(2)
data = {'syllogisms': syllogisms_data, 'transitive': transitive_data}
save_to_json(data, "deductive_reasoning_data_train_192.json")
