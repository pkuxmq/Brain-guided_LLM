...
parser.add_argument('-RESULTS_DIR', type=str, default='./results/finetune_results/')
...
parser.add_argument('-high_sub_index', type=int, default=None)
...
if args.high_sub_index is not None:
    sub_list = acc_sorted_sub_index[args.high_sub_index:args.high_sub_index+1]
